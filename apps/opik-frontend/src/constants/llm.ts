...
export const LLM_PROMPT_TEMPLATES: LLMPromptTemplate[] = [
  ...
  description: "Checks if the output follows a defined JSON or JSON-LD structure",
  value: LLM_JUDGE.structure_compliance, // Add this enum
  messages: [
    {
      id: "kYZITG6", // unique ID
      role: LLM_MESSAGE_ROLE.user,
      content:
  ...
  schema: [
    {
      ...
      description: "Returns True if the output follows the expected structure",
